...
namespace helpers {
    ...
    template <MisbehaviourHandler h, CheckingLevel l> class Plugin {
    public:
    ...
    protected:
        ...
        virtual bool audioPortsActivationCanActivateWhileProcessing() const noexcept {
            return false;
        }
        ...
        virtual bool
        paramsTextToValue(clap_id paramId, const char* display, double* value) noexcept {
            return false;
        }
        ...
        virtual void undoSetContextInfo(uint64_t flags,
        ...
        void hostMisbehaving(const std::string& msg) const noexcept {
            hostMisbehaving(msg.c_str());
        }
